...
#def pixy_search():
  '''
  Funksjon for å fortsette å lete etter lyspunkt dersom man mister feed.
  Søkefunksjonen vil forsøke å lete fem ganger før den overfører kontrollen til manuell.
  '''
#  global lost_counter 
#  print 'Searching...'
#  lost_counter += 1
  ...
  try:
    ...
    while True:
      ...
      if not takeover():
        ...
        #Hvis den ikke finner IR-punkter etter fem forsøk, avbrytes søk.
        #Kontrollen overføres da til manuell. 
        while not send:
          #pixy_search()
          send = get_Pixy()
          lost_counter += 1
